...
#define _VER_ORIGINALFILENAME	"SpoutRenderer.ax"
#define _VER_COMPANY			"Spout"
#define _VER_FILEDESCRIPTION	"SpoutRenderer DirectShow Filter"
#define _VER_PRODUCTNAME		"SpoutRenderer"
#define _VER_INTERNALNAME		"SpoutRenderer.ax"
